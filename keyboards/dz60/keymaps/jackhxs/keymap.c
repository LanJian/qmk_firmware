...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        KC_LCTL , KC_LGUI , KC_LALT , LT(2 , KC_SPC) , MO(1) , LT(3 , KC_ENT) , KC_RALT , XXXXXXX , KC_LEFT , KC_RIGHT , KC_DOWN
    ),
    ...
    LAYOUT(
        ...
        _______ , _______ , _______ , _______ , LCTL(KC_INS) , LSFT(KC_INS) , _______ , _______ , _______ , _______  , _______ , _______ , _______ , _______ ,
    ...
    LAYOUT(
        ...
        _______ , _______ , KC_6    , KC_5    , KC_4    , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
        _______ , _______ , _______ , KC_3    , KC_2    , KC_1    , KC_0    , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
